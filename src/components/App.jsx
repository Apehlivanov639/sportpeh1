        ...
        <section className=" slider_section position-relative">
          <ol className="carousel-indicators indicator-2">
            <li
              ...
              data-slide-to={0}
              className="active indicator-li-1"
            >
              01
            </li>
            ...
            <div className="box">
              <div className="img-box">
                <svg
                  ...
                  style={{ enableBackground: "new 0 0 422.518 422.518" }}
                  xmlSpace="preserve"
                >
                  <path
            ...
            <div className="box">
              <div className="img-box">
                <svg
                  ...
                  style={{ enableBackground: "new 0 0 315.377 315.377" }}
                  xmlSpace="preserve"
                >
                  <g>
                    <g>
            ...
            <div className="col-lg-4 col-md-5 offset-md-1">
              <div className="detail-box">
                ...
                <p>
                  ...
                  hic, dolore error nulla similique cum minima rem, distinctio animi
                  architecto inventore temporibus consequuntur quibusdam modi atque
                  est fuga dicta quae!
                </p>
                <div>
                  <a href="">Buy Now</a>
